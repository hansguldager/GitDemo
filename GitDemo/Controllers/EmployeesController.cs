...
namespace GitDemo.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,Salary,Department,Position")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FirstName,LastName,Salary,Department,Position")] Employee employee)
        {
            if (ModelState.IsValid)
            {
